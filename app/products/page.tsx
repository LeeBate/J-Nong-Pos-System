...
import { Plus, Edit, Trash2, Search, ImageIcon, X, ChevronLeft, ChevronRight } from "lucide-react"
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            ...
            <div className="flex space-x-4">
              <button onClick={() => setShowAddForm(true)} className="flex items-center btn btn-success cursor-pointer">
        ...
        {showAddForm && (
          <div className="card mb-6">
            <div className="p-6 border-b border-gray-200">
              <h2 className="text-lg font-semibold text-gray-900">{editingProduct ? "แก้ไขสินค้า" : "เพิ่มสินค้าใหม่"}</h2>
            </div>
            <div className="p-6">
                ...
                <div className="md:col-span-2">
                  ...
                  {formData.image ? (
                    ...
                    <div className="w-full h-48 border-2 border-dashed border-gray-300 rounded-lg flex flex-col items-center justify-center">
                      ...
                      <p className="text-gray-400 text-xs mt-1">PNG, JPG, GIF (สูงสุด 5MB)</p>
                    </div>
                  )}
                  <input
                    type="file"
        ...
        <div className="card">
          <div className="p-6 border-b border-gray-200">
            <div className="flex justify-between items-center">
              <h2 className="text-lg font-semibold text-gray-900">รายการสินค้า ({filteredProducts.length} รายการ)</h2>
          ...
          <div className="overflow-hidden">
            <div className="overflow-x-auto">
              <div className="h-[25rem] xl:h-[42rem] overflow-y-auto">
                  ...
                  <tbody>
                    {currentProducts.map((product) => (
                      <tr key={product._id}>
                        ...
                        <td className="text-right font-medium text-gray-900">฿{product.price.toLocaleString()}</td>
                        ...
                        <td className="text-gray-900">{product.barcode || "-"}</td>
